...
export const CITIES: City[] = [
  ...
  { slug:"dallas", name:"Dallas", station:"KDAL", lat:32.8473, lon:-96.8514, timezone:"America/Chicago", tzAbbr:"CT", unit:"F", polymarketSlug:"highest-temperature-in-dallas-on", wundergroundSlug:"us/tx/dallas/KDAL", region:"us" },
  ...
  { slug:"london", name:"London", station:"EGLC", lat:51.5048, lon:0.0495, timezone:"Europe/London", tzAbbr:"GMT", unit:"C", polymarketSlug:"highest-temperature-in-london-on", wundergroundSlug:"gb/england/london/EGLC", region:"intl" },
  ...
  { slug:"sao-paulo", name:"São Paulo", station:"SBGR", lat:-23.4356, lon:-46.4731, timezone:"America/Sao_Paulo", tzAbbr:"BRT", unit:"C", polymarketSlug:"highest-temperature-in-sao-paulo-on", wundergroundSlug:"br/sao-paulo/sao-paulo/SBGR", region:"intl" },
...
export function cToF(c: number): number {
  // Use precise decimal conversion then round — same as the original
